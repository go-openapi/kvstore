...
func (o *DeleteEntryURL) Build() (*url.URL, error) {
	...
	if key != "" {
		...
		return nil, errors.New("Key is required on DeleteEntryURL")
	}
...
func (o *DeleteEntryURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteEntryURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteEntryURL")
	}
