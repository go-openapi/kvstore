...
func (o *KvstoreAPI) Authorizer() runtime.Authorizer {
...
func (o *KvstoreAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *KvstoreAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
